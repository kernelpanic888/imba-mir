...
| Первый удар | `TensionState → AttackIntent` | одноразовая инициатива и точная сумма источников |
| Реакция Мира | `WorldVitals → WorldVitals′` | границы жизни и явная цена компенсации |
...
### 7.4 Визуальный алфавит боя

Атака и реакция ДОЛЖНЫ считываться раньше поясняющего текста. Каждый боевой
...
|---|---:|---|
| атака Игрока | `✦` | импульс слева направо к Миру |
